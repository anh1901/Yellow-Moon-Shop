...
public class OrderDetailServlet extends HttpServlet {
    final static Logger logger = Logger.getLogger(OrderDetailServlet.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            orderDetailDTOs=orderDAO.getOrderDetails();
            if(orderDetailDTOs!=null){
                url=SUCCESS;
            request.setAttribute("DETAILS", orderDetailDTOs);
            }
