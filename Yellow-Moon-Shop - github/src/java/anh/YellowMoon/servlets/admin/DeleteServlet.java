...
public class DeleteServlet extends HttpServlet {
    final static Logger logger = Logger.getLogger(DeleteServlet.class.getName());
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(productDAO.deleteProductByID(id)){
                request.setAttribute("MSG", "Deleted product.");
            }else{
                request.setAttribute("MSG", "Fail to deleted product.");
            }
