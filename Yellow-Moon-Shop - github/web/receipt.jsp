<%-- 
    Document   : receipt
    Created on : Oct 11, 2020, 5:24:13 PM
    Author     : DELL
--%>
    ...
    <body>
        ...
        <div class="container" style="padding-top: 10%; padding-bottom: 35%">
            <div class="row d-flex justify-content-center">
                ...
                <br>Check out successfully.</br>
                <br>Your order ID is ${sessionScope.ORDERID}.</br>
                <br>You can view all of your receipt in "Track your order."</br>
                <br>You can only track your order only if you are one of us.</br>
            </div>
        </div>
